...
def process_data():
    ...
    # allocate the data. However, here I am not using the hostnames instead passing data chunk indexes so that containers can also get what they should process.
