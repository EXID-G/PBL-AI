...
##########* create
    ...
    def _create_container(self, hostname, name=None, volumes=None):
        container = self.client.containers.run('jupyter/scipy-notebook/tensorflow', command='sh',detach=True,stdin_open=True,tty=True, hostname=hostname, name=name, volumes = volumes)
