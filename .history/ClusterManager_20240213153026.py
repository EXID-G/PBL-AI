...
if __name__ == "__main__":
    ...
    while True:
        ...
        print("2. Get and list containers' status")
        ...
        try:
            if choice == '1':
                ...
                choice = input("Do want to designate names of containers? (y/n): ")
                if choice == 'y':
                    name_list = input("Enter the name list of the cluster (Separate by space): ")
                    name_list = name_list.split()
                    while( len(name_list) != int(num)):
