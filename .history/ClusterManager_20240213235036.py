...
####### processing data parallel
    def distribute_and_process_data_parallel(self,parallel_num, volume_data_path, process_file,container_idorname_list=None):
        try:
            ...
            with concurrent.futures.ThreadPoolExecutor() as executor:
                # 将每个容器的任务提交到执行器
                futures = [executor.submit(self._process_data_in_container, container, chunk_index, process_file)
    ...
    def _process_data_in_container(self, container, chunk_index, process_file):
        try:
