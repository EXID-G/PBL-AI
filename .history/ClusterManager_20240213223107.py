...
####### processing data parallel
    def distribute_and_process_data_parallel(self,parallel_num, container_data_path,container_idorname_list=None):
        try:
            if (parallel_num > len(self.containers)):
                ...
                return
            data = pickle.load(container_data_path, 'rb')
            ...
            with concurrent.futures.ThreadPoolExecutor() as executor:
                ...
                futures = [executor.submit(self._process_data_in_container, container, chunk_index)
                           for container, chunk in zip(container_list, data_chunks_tuple)]
