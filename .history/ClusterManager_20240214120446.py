...
##########* run
    ...
    def _execute_command_in_container(self, container_id, command):
        ...
        # # check the exit code of command, since exit_code is always None when stream, and online solution is not that useful. Besides. some people said 'it cannot return stream and exit code at the same time' in https://github.com/docker/docker-py/issues/1381. So, I just give up to get the exit code.
